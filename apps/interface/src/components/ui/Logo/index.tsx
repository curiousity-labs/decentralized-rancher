...
export function Logo({ variant = 'light', size = 'sm' }: { size?: "sm" | "lg", variant?: 'light' | 'dark' }) {
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center" lineHeight={lineHeight} color={color}>
      <Flex alignItems="center" justifyContent="center">
        <Text fontSize={smTextFontSize} pb={specialPadding} letterSpacing={letterSpacing} fontWeight="semidbold" fontFamily="sans">
          de
        </Text>
        <Text fontSize={lgTextFontSize} letterSpacing={letterSpacing} fontWeight="light" fontFamily="mono">
          \
        </Text>
        <Text fontSize={smTextFontSize} pt={specialPadding} letterSpacing={letterSpacing} fontWeight="semidbold" fontFamily="sans" >
          centralized
        </Text>
      </Flex>
